...
class CarEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # choose controlling action to either be
        # self.action (manual)
        # or action (agent-controlled)
    ...
    def render(self):
        ...
        # draw waypoint
        self.wp.update_and_draw(self.screen, self.rd, self.Agent, pt_size=4)
