...
class Obs_data:
    ...
    def get_wpa_wpd(self, target_coor, car_pos):
        target_coor_yaw = np.arctan2(
            target_coor[1] - car_pos[1], target_coor[0] - car_pos[0]
        )
    ...
    def get_state(self):
        ...
        self.ey, nearest_wps, closest_track_coor = find_ey(
            car_pos, wp_coors
        )  # TODO: checkme
    ...
    def reset(self):
        ...
        self.wpds = [0] * self.wp.npts
        self.wpas = [0] * self.wp.npts
